const TextScroll = new (function() {
    ...
    this.init = function (config) {
        ...
        this.text              = config.text       || [
            ...
            "Yet, records speak of a survivor and an outcast who would go on to unite the last of the Vikings, whom hid in the forest, and, with their aid (and items laying around the area), face this tentacled threat. Perhaps today we'll put to rest the debates concerning the victors of the Battle for Idrilya."
        ];
